---
title: ORM (doctrine)
description: Integrate Doctrine ORM and Doctrine Migrations into a Slick application, including configuration, custom types, multiple connections, and migration management.
sidebar:
  order: 2
---
