...
description: Integrate a template engine (Twig by default) into a Slick web application. Covers template creation, variables, inheritance, filters, extensions, and custom engine implementation.
sidebar:
  order: 3
---
