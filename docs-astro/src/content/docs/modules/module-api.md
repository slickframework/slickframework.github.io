---
title: Module API
description: API for creating Slick modules with settings, services, HTTP middlewares, and console commands. Covers SlickModuleInterface, WebModuleInterface, and ConsoleModuleInterface.
sidebar:
  order: 1
---
