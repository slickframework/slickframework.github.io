...
description: Configure and use password hashers in Slick, including Bcrypt, Sodium, and PBKDF2 algorithms, with examples for creating, verifying, and upgrading password hashes.
sidebar:
  order: 2
---
