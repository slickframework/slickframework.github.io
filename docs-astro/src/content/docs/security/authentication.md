...
description: Set up authentication and authorization in your Slick application using security profiles, built-in authenticators, custom authenticators, and CSRF protection.
sidebar:
  order: 1
---
