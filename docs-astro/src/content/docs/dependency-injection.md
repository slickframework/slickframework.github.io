...
description: Lightweight dependency injection container for PHP 8.2+ with nested containers, value/factory/alias/object definitions, and autowiring support.
sidebar:
  order: 3
---
