...
description: Easy-to-use solution for managing configuration files in PHP applications using arrays, environment variables, configuration chains, and .env support.
sidebar:
  order: 2
---
